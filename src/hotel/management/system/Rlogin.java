...
public class Rlogin extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            String q = "select * from room where room_number='"+u+"' ";
        ...
        /*else{
            ...
            String vs = t2.getText();
            
            String qs = "INSERT INTO login values( '"+username+"', '"+password+"')";
            
            ResultSet rs = c1.s.executeQuery(qs); 
            if(rs.next()){ 
